...
class external_pisa(Stage):
    ...
    **kwargs
    ...
    def compute_function(self):
        ...
        self.external_params['Deltasq_m31'] = self.params.Deltasq_m31.value.m
        self.external_params['theta23'] = np.radians(self.params.theta23.value.m)
        ...
        for container in self.data:
            ...
            p = self.osc_prob(energies, distances, self.external_params, not bool(container['nubar'] + 1), densities)
